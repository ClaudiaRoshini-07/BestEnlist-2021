...
Dateofbirth = Label(root ,text = "Dateofbirth",width=20,font=("bold", 10)).grid(row = 4,column = 1)
Empid= Label(root,text = "Empid",width=20,font=("bold", 10)).grid(row = 5,column = 1)
