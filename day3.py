...
LastName = Label(root ,text = "Last Name",width=20).grid(row = 2,column = 1)
Dateofbirth = Label(root ,text = "Dateofbirth",width=20).grid(row = 5,column = 1)
Empid= Label(root,text = "Empid",width=20).grid(row = 4,column = 1)
Address = Label(root,text = "Address",width=20).grid(row = 3,column = 1)
Qualification = Label(root ,text = "Qualification").grid(row = 7,column = 1)
